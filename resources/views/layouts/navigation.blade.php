                    ...
                    @if(auth()->user()->isAdmin())
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('feature-flags.index')">
                                    {{ __('Feature Flags') }}
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isAdmin())
                <div class="border-t border-white border-opacity-20 mt-2 pt-2">
                    ...
                    <x-responsive-nav-link :href="route('feature-flags.index')" :active="request()->routeIs('feature-flags.*')">
                        {{ __('Feature Flags') }}
                    </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-white border-opacity-20">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('settings.index')" class="text-white">
                    {{ __('Settings') }}
                </x-responsive-nav-link>
