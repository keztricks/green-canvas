    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-6">Create New User</h2>
                ...
                <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Minimum 8 characters, mixed case, and numbers required</p>
                        @error('password')
                            <p class="text-red-600 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
