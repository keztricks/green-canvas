<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 class="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Create New Export</h2>

        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded">
            <h3 class="font-semibold text-blue-900 dark:text-blue-300 mb-2">Export Information</h3>
        ...
        <form action="{{ route('exports.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                    Version <span class="text-red-600 dark:text-red-400">*</span>
                </label>
                <input type="text" 
                       name="version" 
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                    Format <span class="text-red-600 dark:text-red-400">*</span>
                </label>
                <div class="flex gap-4">
                    ...
                    @else
                        ...
                        <div class="text-sm text-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-gray-700 px-4 py-2 rounded border border-gray-200 dark:border-gray-600">
            ...
            <div class="border-t dark:border-gray-700 pt-6">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">Optional Filters</h3>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="flex items-center space-x-2 cursor-pointer">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-200">Include addresses that have not been knocked</span>
                        </label>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-6">When checked, the export will include all addresses in the selected scope, even those without any knock results</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Filter results by a specific ward</p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" 
                                   name="date_from" 
                                   class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#6AB023]">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Start of date range</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                                Date To
                            ...
                            <input type="date" 
                                   name="date_to" 
                                   class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#6AB023]">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">End of date range</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                <h4 class="font-semibold text-gray-800 dark:text-white mb-2">Export will include:</h4>
