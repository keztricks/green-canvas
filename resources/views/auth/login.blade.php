    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-6">
            @if (Route::has('password.request'))
                <a class="underline text-sm text-[#6AB023] hover:text-[#5a9620] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6AB023]" href="{{ route('password.request') }}">
